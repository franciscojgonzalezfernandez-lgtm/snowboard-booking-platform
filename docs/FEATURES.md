...
- Tests:
  ...
  - [x] Playwright `e2e/f-076-admin.spec.ts` (4 specs): no-admin → 404; admin aterriza en calendario, abre y cierra un día del instructor seleccionado; admin crea instructor → aparece en lista + persiste rol instructor; modo "All" abre y cierra un día para todos los instructores activos (2 instructores → ambos AVAILABLE tras open, 0 tras close). Suite unit completa 326/326, `tsc` + `eslint` limpios.
- Notas:

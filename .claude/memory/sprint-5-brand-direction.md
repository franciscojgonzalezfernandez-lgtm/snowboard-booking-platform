...
- **Motion: `motion` lib, choreographed** (scroll reveal, parallax, animated drop-fall, view transitions), always gated behind `prefers-reduced-motion`. F-090 updates the CLAUDE.md "subtle only" rule.
